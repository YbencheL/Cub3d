...
/*   Updated: 2025/07/02 11:01:11 by ybenchel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    data->north.img = mlx_xpm_file_to_image(data->mlx, "textures/lol3.xpm", &data->north.width, &data->north.height);
    data->north.addr = mlx_get_data_addr(data->north.img, &data->north.bbq, &data->north.sizel, &data->north.indian);
    
    data->south.img = mlx_xpm_file_to_image(data->mlx, "textures/lol3.xpm", &data->south.width, &data->south.height);
    ...
    data->east.img = mlx_xpm_file_to_image(data->mlx, "textures/lol3.xpm", &data->east.width, &data->east.height);
