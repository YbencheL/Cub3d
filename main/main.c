...
/*   Updated: 2025/07/02 11:34:13 by ybenchel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    data->north.img = mlx_xpm_file_to_image(data->mlx, "textures/west.xpm", &data->north.width, &data->north.height);
    ...
    data->west.img = mlx_xpm_file_to_image(data->mlx, "textures/east.xpm", &data->west.width, &data->west.height);
